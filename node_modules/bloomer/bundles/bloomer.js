...
function getGridSizesModifiers(isSize, isOffset, platform) {
    ...
    return (Number.isInteger(isSize) && isValidSize(isSize)) ? (_a = {}, _a["is-" + (isOffset ? 'offset-' : '') + isSize + (isPlatform(platform) ? "-" + platform : '')] = true, _a) : {};
    var _a;
}
...
var Radio_1 = __webpack_require__(85);
...
var PageControl_1 = __webpack_require__(59);
exports.PageControl = PageControl_1.default;
var Ellipsis_1 = __webpack_require__(57);
exports.PageEllipsis = Ellipsis_1.default;
var Page_1 = __webpack_require__(58);
exports.Page = Page_1.default;
var PageList_1 = __webpack_require__(61);
exports.PageList = PageList_1.default;
var PageLink_1 = __webpack_require__(60);
exports.PageLink = PageLink_1.default;
var Panel_1 = __webpack_require__(63);
exports.Panel = Panel_1.default;
var PanelHeading_1 = __webpack_require__(65);
exports.PanelHeading = PanelHeading_1.default;
var PanelTabs_1 = __webpack_require__(68);
exports.PanelTabs = PanelTabs_1.default;
var PanelTab_1 = __webpack_require__(67);
exports.PanelTab = PanelTab_1.default;
var PanelBlock_1 = __webpack_require__(64);
exports.PanelBlock = PanelBlock_1.default;
var PanelIcon_1 = __webpack_require__(66);
exports.PanelIcon = PanelIcon_1.default;
var Tabs_1 = __webpack_require__(72);
...
var TabLink_1 = __webpack_require__(70);
exports.TabLink = TabLink_1.default;
var Container_1 = __webpack_require__(100);
exports.Container = Container_1.default;
var Footer_1 = __webpack_require__(101);
exports.Footer = Footer_1.default;
var Section_1 = __webpack_require__(107);
exports.Section = Section_1.default;
var Hero_1 = __webpack_require__(102);
exports.Hero = Hero_1.default;
var HeroHeader_1 = __webpack_require__(105);
exports.HeroHeader = HeroHeader_1.default;
var HeroBody_1 = __webpack_require__(103);
exports.HeroBody = HeroBody_1.default;
var HeroVideo_1 = __webpack_require__(106);
exports.HeroVideo = HeroVideo_1.default;
var HeroFooter_1 = __webpack_require__(104);
...
function NavItem(_a) {
    ...
    var className = classNames('nav-item', tslib_1.__assign({ 'is-tab': props.isTab, 'is-brand': props.isBrand }, bulma_1.getActiveModifiers(props)), props.className);
...
function NavbarItem(_a) {
    ...
    var className = classNames('navbar-item', tslib_1.__assign({ 'is-hoverable': isHoverable, 'has-dropdown': hasDropdown }, bulma_1.getActiveModifiers(props)), props.className);
    var HTMLProps = helpers_1.getHTMLProps(props, bulma_1.removeActiveModifiers);
    if (render)
        return render(tslib_1.__assign({}, HTMLProps, { className: className }));
    return React.createElement((props.href ? 'a' : tag), tslib_1.__assign({}, HTMLProps, { className: className }));
...
function PageControl(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'a' : _b, render = _a.render, props = tslib_1.__rest(_a, ["tag", "render"]);
    var className = classNames(tslib_1.__assign({ 'pagination-previous': !props.isNext, 'pagination-next': !props.isPrevious && props.isNext }, helpers_1.combineModifiers(props, bulma_1.getActiveModifiers, bulma_1.getFocusedModifiers)), props.className);
...
function Checkbox(props) {
    ...
    return (React.createElement("label", { className: wrapperClassName, disabled: HTMLProps.disabled },
...
function Hero(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'section' : _b, props = tslib_1.__rest(_a, ["tag"]);
    var className = classNames('hero', tslib_1.__assign({ 'is-bold': props.isBold, 'is-fullheight': props.isFullHeight, 'is-halfheight': props.isFullHeight }, helpers_1.combineModifiers(props, bulma_1.getColorModifiers, bulma_1.getSizeModifiers)), props.className);
